          ...
          <div className="container mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {courses.map((course, index) => (
                <Card key={index} className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-0 bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm">
                          ...
                          <div className="p-6 pt-4">
                            <div className="aspect-video rounded-lg overflow-hidden bg-black">
                              <iframe
                                width="100%"
                                height="100%"
                                src={getEmbedUrl(course.videoId)}
                                title={course.title}
                                frameBorder="0"
                            ...
                            <div className="mt-4 flex items-center justify-between">
                              ...
                              <Button variant="outline" size="sm" asChild>
                                <a 
                                  href={`https://youtube.com/playlist?list=${course.playlistId || `watch?v=${course.videoId}`}`}
                                  target="_blank"
