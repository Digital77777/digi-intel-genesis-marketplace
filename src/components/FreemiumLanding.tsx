...
const FreemiumLanding = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-background dark:to-blue-900/20">
      ...
      <section id="features" className="py-16 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 bg-rose-50">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Progress & Achievements */}
            <div>
              <h3 className="text-2xl font-bold mb-6 text-blue-700">Your AI Journey Progress</h3>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              {/* Future Growth */}
              <Card className="border-2 border-purple-200 bg-gradient-to-br from-purple-50 to-pink-50 bg-indigo-700">
                ...
                <CardContent className="space-y-3 bg-slate-100">
                  <div className="flex items-center gap-2">
