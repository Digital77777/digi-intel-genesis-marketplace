...
const jobs = [
  {
    ...
    location: "Remote",
    type: "Full-time",
    budget: { min: 120000, max: 180000, currency: "$", period: "year" },
  ...
  },
  {
    ...
    location: "Remote",
    type: "Contract",
    budget: { min: 5000, max: 8000, currency: "$", period: "project" },
  ...
  },
  {
    ...
    type: "Full-time",
    budget: { min: 90000, max: 130000, currency: "$", period: "year" },
  ...
  },
  {
    ...
    type: "Internship",
    budget: { min: 6000, max: 8000, currency: "$", period: "month" },
  ...
  },
  {
    ...
    location: "Remote",
    type: "Contract",
    budget: { min: 80, max: 120, currency: "$", period: "hour" },
...
const MarketplaceJobs = ({ searchQuery }: JobsProps) => {
  ...
  const formatBudget = (budget: any) => {
    const { min, max, currency, period } = budget;
